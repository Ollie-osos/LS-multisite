<?php
/**
 * A template partial to output pagination for the Laurence Simons 2022 default theme.
 *
 * @link
 *
 * @package WordPress
...
$prev_text = sprintf(
	 ...
	 */
	__( 'Newer <span class="nav-short">Posts</span>', 'lss' )
);
$next_text = sprintf(
	 ...
	 * The text inside the span with the class nav-short will be hidden on small screens.
	 */
	__( 'Older <span class="nav-short">Posts</span>', 'lss' ),
