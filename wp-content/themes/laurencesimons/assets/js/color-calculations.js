 ...
 * @return {Object} - this
 */
function _lssColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_lssColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_lssColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_lssColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _lssColor object.
 *
 * @since Laurence Simons 2022 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function lssColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _lssColor( backgroundColor, accentHue );
