...
$title = get_field('page_title_case_studies', 'option');
$header = get_field('header_case_studies', 'option');
...
<?php
if( have_rows('page_builder_case_studies', 'option') ):

    while ( have_rows('page_builder_case_studies', 'option') ) : the_row();
