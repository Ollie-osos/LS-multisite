...
$title = get_field('page_title_testimonials', 'option');
$header = get_field('header_testimonials', 'option');
...
<?php
if( have_rows('page_builder_testimonials', 'option') ):

    while ( have_rows('page_builder_testimonials', 'option') ) : the_row();
